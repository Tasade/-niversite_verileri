...
if len(filt) == 0:
    ...
    f3.update_layout(**layout(
        ...
        title=dict(
            ...
            font=dict(color="#2A1F12", family="Syne", size=14),
        ),
        xaxis=dict(
            tickangle=-40,
            gridcolor="#D8CFBE",
            color="#3A3020",
            tickfont=dict(size=10, color="#3A3020", family="DM Sans"),
            showline=True,
            linecolor="#C0B090",
        ),
        yaxis=dict(
            gridcolor="#D8CFBE",
            color="#3A3020",
            title=dict(text="Ortalama Basari Sirasi", font=dict(color="#5A4A34", size=11)),
            tickfont=dict(size=10, color="#3A3020"),
            showline=True,
            linecolor="#C0B090",
        ),
        legend=dict(
            title=dict(text="Yil", font=dict(color="#2A1F12", size=12, family="Syne")),
            font=dict(size=12, color="#2A1F12", family="DM Sans"),
            bgcolor="rgba(252,249,244,0.95)",
            bordercolor="#C8B890",
            borderwidth=1,
            orientation="h",
            x=0, y=1.09,
